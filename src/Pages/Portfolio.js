...
function Portfolio() {
  return (
    ...
    style={{
      backgroundImage: "url('/images/back.jpg')", // ✅ Background Image Added
  ...
  >
        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link href="/r.pdf" download className="text-white">Resume</Nav.Link>
            </Nav>
          </Navbar.Collapse>
        </Container>
      </Navbar>
      ...
      <div 
  id="home" 
  className="container-fluid text-white d-flex align-items-center justify-content-center" 
  style={{ 
    minHeight: "100vh",
    backgroundImage: "url('/images/background.jpg')", // 🔹 Add your background image path
    backgroundSize: "cover",
    backgroundPosition: "center",
    backgroundRepeat: "no-repeat",
  }}
>
  <div className="container text-center p-5" style={{ backgroundColor: "rgba(65, 80, 71, 0.9)", borderRadius: "10px" }}>
    <div className="row align-items-center">
      ...
      <main className="col-md-8">
        <motion.h2
          className="fw-bold text-white" // ✅ Changed text color to white for readability
        ...
        >
          Feel free to explore my projects to see how I bring ideas to life through code.  
      ...
      {/* ✅ Projects Section */}
      <div className="container text-center p-5" style={{ backgroundColor: "rgba(65, 80, 76, 0.9)", borderRadius: "10px" }}>
        <h2 className="text-center text-white fw-semibold mb-4">Projects</h2>
        <div className="row">
      ...
      <div
  id="skills"
  className="container mt-5 text-white p-4 rounded shadow-lg"
  style={{ backgroundColor: "rgba(65, 80, 76, 0.9)" }} // RGBA applied here
>
  ...
  id="certifications"
  className="container mt-5 text-white p-4 rounded shadow-lg"
  style={{ backgroundColor: "rgba(65, 80, 76, 0.9)" }} // Applied RGBA color
>
  ...
  <ul className="list-unstyled text-center">
    {certifications.map((cert, index) => (
      ...
      <div
  id="contact"
  className="container text-center mt-5 text-white p-4 rounded shadow-lg"
  style={{ backgroundColor: "rgba(65, 80, 76, 0.9)" }} // Applied RGBA color
>
  ...
  <p className="mb-3">
    📞 <a href="tel:+91 6309195703" className="text-blue-600 fw-bold">+91 6309195703</a>
  </p>
